...
class CNNMnist(nn.Module):
    def __init__(self, args):
        ...
        self.conv2 = nn.Conv2d(10, 20, kernel_size=5)#20
        #self.conv2_drop = nn.Dropout2d()
        #https://discuss.pytorch.org/t/confusion-about-dropout2d/21958
    ...
    def forward(self, x):
        ...
        # -1 Count the number of columns or rows by self   
        #Image vertical dimension horizontal dimension channel number(colours 3 gray 1)
        x = F.relu(self.fc1(x))
